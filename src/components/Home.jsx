  ...
  return (
    ...
    <div>
      <section className="flex justify-between items-center bg-white py-20 px-28 Gilroy-Medium ">
        <div className="">
          <p className="text-5xl font-bold "><span className="text-green-400 italic font-semibold">Fresh</span> Food With </p>
          <p className="text-5xl font-bold py-4">Good <span className="text-orange-400 italic font-semibold">Taste</span></p>
